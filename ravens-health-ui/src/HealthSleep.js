...
// Function to get the last N days of health data
const lastNDays = (n) => healthData.slice(-n);

// Specify the colors to be used in the pie chart
...
// Render the pie chart with custom labels and styles
...
const HealthSleep = () => {
    ...
    // Calculate averages for each sleep stage for the pie chart
    ...
    // Round sleep data to 1 decimal place for display purposes
    ...
    // Update the active index in the pie chart when hovering over a segment
    const onPieEnter = (_, index) => {
        setActiveIndex(index);
    };

    // Update the number of days to display in the chart based on the dropdown selection
        ...
        <div className="container" height="80 vh">
            ...
            <div style={{width: "90%", height: "650px", display: "flex"}}>
                ...
                <div style={{flex: '50%', padding: '0 8px', marginTop: '40px'}}>
                    <h3 style={{textAlign: 'center', fontFamily: 'Consolas', margin: '0'}}> The Amount of Hours Spent
                        During Each Level of Sleep </h3>
