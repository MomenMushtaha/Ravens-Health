...
// Render the active shape for the pie chart
...
// Main component for the health activity visualization
const HealthActivity = () => {
    ...
    // Calculate averages for each activity stage for the pie chart
            ...
            <div style={{width: "90%", height: "650px", display: "flex"}}>
                ...
                <div style={{flex: '50%', padding: '0 8px', marginTop: '40px'}}>
                    <h3 style={{textAlign: 'center', fontFamily: 'Consolas', margin: '0'}}> The Amount of Hours Spent
                        During Each Level of Activity </h3>
